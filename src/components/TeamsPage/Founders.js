			...
			<article className="founder member">
				<div className="photo-image">
					...
					<div className="photo-details">
						...
						<span>
							<a href="mailto:surajgupta.3072@gmail.com" target="_blank">
						...
						<span>
							<a href="https://github.com/surajgupta3072/" target="_blank">
			...
			<article className="founder member">
				<div className="photo-image">
					...
					<div className="photo-details">
						...
						<span>
							<a href="mailto:bhushantny1@gmail.com" target="_blank">
								<FontAwesomeIcon icon="envelope" />
							</a>
						</span>
						<span>
							<a href="https://www.instagram.com/_.bhushan._/" target="_blank">
								<FontAwesomeIcon icon={['fab', 'instagram']} />
							</a>
						</span>
						<span>
						...
						<span>
							<a href="https://github.com/imshresth0810" target="_blank">
								<FontAwesomeIcon icon={['fab', 'github']} />
							</a>
						</span>
					</div>
